...
let generateRating = function() {
  return Math.floor(Math.random() * 6);
}
let generateText = function(text) {
...
let allReviews = function(arrayOfRandomNumbers) {
  var reviews = [];
...
let fillReviews = function(reviews) {
let query = '';
